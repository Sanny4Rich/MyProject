...
class Atributes
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity="App\Entity\Categories", mappedBy="attributes")
     */
    private $categories;

    /**
     * @ORM\OneToMany(targetEntity="App\Entity\AttributeValues", mappedBy="attribute", orphanRemoval=true)
     */
